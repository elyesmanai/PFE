            ...
            <div class="col-lg-12 data">
               <br>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <a href="/projects/create"><button class="btn btn-success pull-right">Nouveau projet</button></a>
                        </div>
                ...
                <tbody>
                    @foreach($projects as $project)
                        ...
                        <td>{{$project->year}}</td>
                        <td>
                                        <button class="btn btn-warning"  data-toggle="modal" data-target="#myModal1{{$project->id_project}}"> Modifier</button>
                                     <a href="{{action('ProjectController@destroy', $project->id_project)}}"><button class="btn btn-danger">Supprimer </button></a>
                                         ...
                                         <div class="modal-content">
                                          ...
                                          <div class="modal-body " >
                                           ...
                                           <br> 
                                             ...
                                             <br> 
                                           <label class="col-sm-4 control-label">Etape</label>
                                            <div class="col-sm-8">
