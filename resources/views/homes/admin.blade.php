      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="/deadlines" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Les étapes à faire </h3>
            ...
            <div class="box-body">
              <ul class="todo-list">
                <li>
                  ...
                  <!-- todo text -->
                  <span class="text">prendre les résultats du diagnostique techniques du téchniciens</span>
                  <!-- Emphasis label -->
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">prendre les résultats du diagnostique finances du financiers</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">contacter les sociétés civiles</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">diviser les taches du siciétés civiles</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">faire la premiére session avec les citoyens</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">faire la session  des zones</span>
                ...
                <li>
                  ...
                  <input type="checkbox" value="">
                  <span class="text">faire la derniére session  avec les cityens</span>
                  <div class="tools">
                    <i class="fa fa-edit"></i>
                    <i class="fa fa-trash-o"></i>
                  </div>
       ...
       <br
        <section class="col-lg-5 connectedSortable">
             ...
             <div class="progress-group">
                    <span class="progress-text">pré-vote</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Vote</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Post-vote</span>
                    <span class="progress-number"><b>0%</b></span>
